...
export default function Home() {
  ...
  return (
    <div
      ...
      className="rotate-180 bg-contain bg-bottom">
      <div className="rotate-180 bg-neutral-100/75 backdrop-blur">
        <div className="container">
          <div className="flex min-h-screen flex-col items-center justify-center text-center">
            ...
            <div className="mb-8">
              ...
              <p>
                Subscribe to our newsletter to receive notifications when we
                arrive.
              </p>
            </div>
            <form
          ...
          <div className="mt-32 pb-1 text-center">
